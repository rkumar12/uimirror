...
import com.uimirror.reach.conf.DispatcherConfig;
import com.uimirror.reach.conf.WebAppInitializer;
...
@ComponentScan(basePackages= {"com.uimirror.reach"})
@Import({
