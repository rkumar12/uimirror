...
import com.uimirror.reach.core.coordinate.GeographicCoordinateType.CoordinateConstants;
...
public final class Geometry implements Serializable {
    ...
    private Geometry(Builder builder) {
        ...
        this.locationType = (builder.locationType != null) ? builder.locationType : LocationType.APPROXIMATE;
