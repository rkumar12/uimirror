...
import com.uimirror.oauth2.conf.DispatcherConfig;
import com.uimirror.oauth2.conf.WebAppInitializer;
...
@ComponentScan(basePackages= {"com.uimirror.oauth2"})
@Import({
	DispatcherConfig.class, WebAppInitializer.class
})
public class StartApp {
	...
	@Value("${tomcat.contextPath:/uim}/${application.id:oauth2}")
