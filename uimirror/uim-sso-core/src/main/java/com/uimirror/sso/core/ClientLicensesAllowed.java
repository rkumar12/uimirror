 ...
 * The value of the ClientLicensesAllowed annotation is a list of security license names. 
...
@Retention (RUNTIME)
@Target({TYPE, METHOD})
public @interface ClientLicensesAllowed {
	String[] value();
}
