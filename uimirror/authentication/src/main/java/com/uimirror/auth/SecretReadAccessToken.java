 ...
 * @author Jay
 */
public final class SecretReadAccessToken extends SecretAccessToken{

	private static final long serialVersionUID = 8013590333214704876L;

	public SecretReadAccessToken(String id, String expireOn) {
		super(id, expireOn, AccessTokenScope.READ);
	}
	
	public SecretReadAccessToken(Token token, String id, String expireOn) {
