...
public interface AccessTokenService {
	 ...
	 */
	public AccessToken getAccessTokenDetailsByTokenId(final String token) throws AccessTokenException, IllegalArgumentException;
	 ...
	 * @throws IllegalArgumentException if input_parameter is not correct
	 */
	public AccessToken getActiveAccessTokenDetailsByTokenId(final String token) throws AccessTokenException, IllegalArgumentException;
