...
do
  case $opt in
   ...
   if [[ $user == "" ]] && [[ $pass == "" ]]
   then
      echo "mongo --quiet -h $m_host -p $m_port  "uim_usr" --eval 'db.dropDatabase()'";
      echo "mongo --quiet -h $m_host -p $m_port  "uim_ouath" --eval 'db.dropDatabase()'";
      echo "mongo --quiet -h $m_host -p $m_port  "uim_ouath_token" --eval 'db.dropDatabase()'";
      echo "mongo --quiet -h $m_host -p $m_port  "uim_client" --eval 'db.dropDatabase()'";
   else
