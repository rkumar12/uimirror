...
@IntegrationTest
@DirtiesContext
public class ExtraAuthenticationEndPointTest {

	@Test
	public void grantClientAccessTest() {
		...
		ResponseEntity<String> entity = rst.postForEntity("http://127.0.0.1:8080/uim/account/auth/clint/permit?cb=print&scope=rw&approval=y", request, String.class);
