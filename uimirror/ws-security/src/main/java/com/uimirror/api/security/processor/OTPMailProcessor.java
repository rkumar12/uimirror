...
public class OTPMailProcessor extends AbstractBackgroundProcessor<AccessToken, Object>{
	...
	/* (non-Javadoc)
	 * @see com.uimirror.ws.auth.auth.controller.BackgroundProcessor#invoke(java.lang.Object)
	 */
	@Override
	public void invoke(final AccessToken token){
