 ...
 * Uimirror Team
 *******************************************************************************/
package com.uimirror.ws.account;
...
import com.uimirror.ws.account.conf.AppConfig;
import com.uimirror.ws.account.conf.BeanIntitializer;
import com.uimirror.ws.account.conf.WebAppInitializer;
...
@ComponentScan(basePackages= {"com.uimirror.ws.account"})
@Import({
