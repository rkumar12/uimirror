...
/**
 * This will search the location first from the 
 * @author Jay
 */
public class LocationSearchByText implements Processor<LocationQueryForm, String>{

	/**
	 * 
	 */
	public LocationSearchByText() {
