...
import com.uimirror.location.core.GeocodeException;
...
import com.uimirror.location.core.components.GeographicArea;
import com.uimirror.location.core.components.GeographicLocation;
import com.uimirror.location.core.components.Geometry;
...
public class JsonGeocodeResponseParserTest {
    ...
    public void shouldParseJsonGeocodeResponse() throws Exception {
        ...
        Geometry expectedGeometry = Geometry.newBuilder(GeographicLocation.fromValues(37.4227820, -122.0850990))
                .setLocationType(LocationType.ROOFTOP)
        ...
        GeocodedAddress expectedGeocodedAddress = GeocodedAddress.newBuilder("1600 Amphitheatre Pkwy, Mountain View, CA 94043, USA")
                .addAddressType(AddressComponentType.STREET_ADDRESS)
                ...
                .addAddressComponent(AddressComponent.newBuilder(AddressComponentType.LOCALITY).addAddressComponentType(AddressComponentType.POLITICAL).setLongName("Mountain View").setShortName("Mountain View").build())
                .addAddressComponent(AddressComponent.newBuilder(AddressComponentType.ADMINISTRATIVE_AREA_LEVEL_3).addAddressComponentType(AddressComponentType.POLITICAL).setLongName("San Jose").setShortName("San Jose").build())
                .addAddressComponent(AddressComponent.newBuilder(AddressComponentType.ADMINISTRATIVE_AREA_LEVEL_2).addAddressComponentType(AddressComponentType.POLITICAL).setLongName("Santa Clara").setShortName("Santa Clara").build())
                .addAddressComponent(AddressComponent.newBuilder(AddressComponentType.ADMINISTRATIVE_AREA_LEVEL_1).addAddressComponentType(AddressComponentType.POLITICAL).setLongName("California").setShortName("CA").build())
                .addAddressComponent(AddressComponent.newBuilder(AddressComponentType.COUNTRY).addAddressComponentType(AddressComponentType.POLITICAL).setLongName("United States").setShortName("US").build())
        ...
        assertThat(googleGeocodeResponse.getGeocodeStatus(), is(GeocodeStatus.OK));
