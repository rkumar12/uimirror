...
public enum GeographicCoordinateType {
    ...
    private boolean isZeroCardinalDirection(CardinalDirection cardinalDirection) {
        return (cardinalDirection == CardinalDirection.ZERO_LATITUDE_DEGREE) || (cardinalDirection == CardinalDirection.ZERO_LONGITUDE_DEGREE);
    }
    ...
    private boolean isLongitudialDirection(CardinalDirection cardinalDirection) {
        return (cardinalDirection == CardinalDirection.EAST) || (cardinalDirection == CardinalDirection.WEST);
    }

    private boolean isLatitudialDirection(CardinalDirection cardinalDirection) {
        return (cardinalDirection == CardinalDirection.NORTH) || (cardinalDirection == CardinalDirection.SOUTH);
    }
