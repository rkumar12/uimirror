...
import com.uimirror.location.core.util.Iterators;
...
public final class GeocodedAddress implements Serializable {
    ...
    private GeocodedAddress(Builder builder) {
        ...
        this.geometry = (builder.geometry != null) ? builder.geometry : Geometry.newBuilder(GeographicLocation.fromCoordinates(GeographicCoordinate.EQUATOR, GeographicCoordinate.PRIME_MERIDIAN)).build();
