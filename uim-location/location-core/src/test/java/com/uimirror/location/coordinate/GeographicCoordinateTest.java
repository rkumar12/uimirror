...
import com.uimirror.location.core.coordinate.GeographicCoordinate;
...
public class GeographicCoordinateTest {
    ...
    public void shouldCreateLatitudeFromBigDecimal() {
        ...
        assertThat(latitude.getCardinalDirection(), is(CardinalDirection.NORTH));
    }
    ...
    public void shouldCreateLongitudeFromBigDecimal() {
        ...
        assertThat(longitude.getCardinalDirection(), is(CardinalDirection.EAST));
    }
    ...
    public void shouldCreateGeographicCoordinateFromAngle() {
        ...
        assertThat(geographicCoordinate.getCardinalDirection(), is(CardinalDirection.NORTH));
    }
    ...
    public void shouldSetCardinalDirectionCorrectly() {
        ...
        assertThat(northernLatitude.getCardinalDirection(), is(CardinalDirection.NORTH));
        assertThat(equator.getCardinalDirection(), is(CardinalDirection.ZERO_LATITUDE_DEGREE));
        assertThat(southernLatitude.getCardinalDirection(), is(CardinalDirection.SOUTH));
        assertThat(easternLongitude.getCardinalDirection(), is(CardinalDirection.EAST));
        assertThat(primeMeridian.getCardinalDirection(), is(CardinalDirection.ZERO_LONGITUDE_DEGREE));
        assertThat(westernLongitude.getCardinalDirection(), is(CardinalDirection.WEST));
    }
